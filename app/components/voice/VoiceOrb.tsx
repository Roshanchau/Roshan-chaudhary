  ...
  if (dismissed) {
    ...
    return (
      <button
        ...
        title={reopenLabel}
        className="flex h-11 w-11 items-center justify-center rounded-full bg-[rgba(123,196,127,0.95)] text-[rgb(17,16,29)] shadow-[0_8px_24px_rgba(0,0,0,0.3)] ring-2 ring-[rgba(63,139,81,0.6)] transition-all hover:scale-105 active:scale-95"
      >
        <FiMic size={18} />
      </button>
    );
